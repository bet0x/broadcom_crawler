---
source_url: https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/advanced-network-management/administration-guide/nsx-multi-tenancy/nsx-virtual-private-clouds/add-user-role-assignments-for-an-nsx-vpc/add-role-assignments-for-an-nsx-vpc-from-the-user-management-page.html
product: vmware-cloud-foundation
version: 9.0
section: NSX
breadcrumb: NSX > Add Role Assignments for an NSX VPC from the User Management Page
---

# Add Role Assignments for an NSX VPC from the User Management Page

Use the instructions in this documentation to add user role assignments for an
NSX VPC from the User
Management page.
...
steps for adding role assignments in NSX VPCs for local user accounts and LDAP user accounts. The
steps to add role assignments for vIDM and OpenID Connect user accounts are almost
similar, and therefore not covered in this procedure.
...
2. Navigate to SystemUser Management.
   ...
   displayed.
3. To add role assignments in NSX
   VPCs for a local user account, do these steps:
   1. Next to the local user
      account name, click ![Actions menu.](/content/broadcom/techdocs/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/_jcr_content/assetversioncopies/7504cc2e-f1d9-49a4-8e3d-c53a8d1e944b.original.png), and then click Edit.
...
4. To add role assignments in NSX
   VPCs for an LDAP user account, do these steps:
   ...
   6. Click Add
      ...
      3(c) though 3(e), to assign roles to the LDAP user in the NSX VPC.