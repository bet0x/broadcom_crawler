---
source_url: https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/advanced-network-management/administration-guide/virtual-private-cloud-in-nsx/transit-gateways/add-a-nat-rule-for-transit-gateway.html
product: vmware-cloud-foundation
version: 9.0
section: NSX
breadcrumb: NSX > Add a NAT Rule for Transit Gateway
---

# Add a NAT Rule for Transit Gateway

You can add a NAT rule to a Transit Gateway for external address binding.
...
5. In the NAT field, click Set in the NAT field.
...
7. Enter the following information.
   ...
   | Priority | Enter a priority value.  A lower value means a higher priority. The default is 0. A No SNAT or No DNAT rule should have a higher priority than other rules. |
