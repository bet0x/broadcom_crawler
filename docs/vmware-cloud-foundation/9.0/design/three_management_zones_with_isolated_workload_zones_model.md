---
source_url: https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/design/design-library/self-service-iaas-deployment-models/vsphere-supervisor-zone-models/three-management-zones-with-isolated-workload-zones-model.html
product: vmware-cloud-foundation
version: 9.0
section: Design
breadcrumb: Design > Three Management Zones with Isolated Workload Zones Model
---

# Three Management Zones with Isolated Workload Zones Model

A Three Management Zones Supervisor Model with Isolated Workload Zones Model utilizes resources from three dedicated vSphere Zones for control plane VMs. Workloads are isolated from the Management Zone by deploying into additional vSphere Zones. Management workload availability protection is provided using vSphere HA and can tolerate a single cluster failure. Workload availability protection is provided using vSphere HA and can be distributed across multiple zones for increased availability.
...
## Three Management Zones with Isolated Workload Zones Model Attributes
...
## Three Management Zones with Isolated Workload Zones Model Options
