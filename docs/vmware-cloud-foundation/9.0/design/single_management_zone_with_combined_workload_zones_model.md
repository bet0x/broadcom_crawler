---
source_url: https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/design/design-library/self-service-iaas-deployment-models/vsphere-supervisor-zone-models/single-zone.html
product: vmware-cloud-foundation
version: 9.0
section: Design
breadcrumb: Design > Single Management Zone with Combined Workload Zones Model
---

# Single Management Zone with Combined Workload Zones Model

A Single Management Zone with Combined Workload Zones Model utilizes resources from a single vSphere Zone for management and workloads. Availability protection is provided using vSphere HA.
...
## Single Management Zone with Combined Workload Zones Model Attributes

| Attribute | Detail |
| --- | --- |
| Supervisor Management Zone | Single |
| Supervisor Workload Zones | Single - Combined with management |
| Activation | - At workload domain creation OR - From vCenter. |

## Single Management Zone with Combined Workload Zones Model Options
