---
source_url: https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/deployment/converging-your-existing-vsphere-infrastructure-to-a-vcf-or-vvf-platform-/supported-scenarios-to-converge-to-vcf/converge-your-existing-vcenter-instance-esx-hosts-vrealize-suite-lifecycle-manager-and-vmware-aria-operations.html
product: vmware-cloud-foundation
version: 9.0
section: Deployment, Convergence, and Upgrade
breadcrumb: Deployment, Convergence, and Upgrade > Converging a vCenter Instance, ESX Hosts, VMware Aria Suite Lifecycle, and VMware Aria Operations
---

# Converging a vCenter Instance, ESX Hosts, VMware Aria Suite Lifecycle, and VMware Aria Operations

To successfully converge your existing vCenter instance, ESX hosts, VMware Aria Suite Lifecycle, and VMware Aria Operations, you must ensure that you comply with the prerequisites, follow the procedure, and perform the next steps.
...
| --- | --- | --- |
| Minimum component versions prior to running the VCF Installer workflow | - VMware Aria Lifecycle 8.18 - VMware Aria Operations 8.18 - VMware vCenter 9.0 - VMware ESX 9.0 | - VMware Aria Lifecycle 8.18 - VMware Aria Operations 8.18 - VMware vCenter 8.0 Update 1a - VMware ESX 8.0 Update 1a - VMware NSX 4.1.0.2 |
...
VMware Aria Suite Lifecycle is not upgraded to version 9.0.x. After the VCF Operations fleet management appliance is deployed, the existing connection with VMware Аria Operations is automatically imported to the new appliance.
...
3. Ensure your vCenter instance is running the supported version for your convergence scenario.
...
4. Ensure your ESX hosts are running the supported version for your convergence scenario.
...
5. Deploy the VCF Installer appliance.
...
6. Download binaries to the VCF Installer appliance.
...
7. Deploy VCF 9.0.x by using your existing components as starting building blocks.
...
8. Deploy the remaining components.
