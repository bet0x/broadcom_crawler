...
During the procedure, you use the VMware Cloud Foundation Installer to specify deployment information for your existing vCenter instance and ESX hosts, and to deploy VCF Operations to complete the converging to VMware vSphere Foundation platform.
