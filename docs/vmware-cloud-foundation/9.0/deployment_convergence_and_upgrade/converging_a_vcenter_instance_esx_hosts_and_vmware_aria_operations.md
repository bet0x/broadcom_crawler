---
source_url: https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/deployment/converging-your-existing-vsphere-infrastructure-to-a-vcf-or-vvf-platform-/supported-scenarios-to-converge-to-vcf/converge-your-existing-vcenter-instance-esx-hosts-and-vmware-aria-operations.html
product: vmware-cloud-foundation
version: 9.0
section: Deployment, Convergence, and Upgrade
breadcrumb: Deployment, Convergence, and Upgrade > Converging a vCenter Instance, ESX Hosts, and VMware Aria Operations
---

# Converging a vCenter Instance, ESX Hosts, and VMware Aria Operations

To successfully converge your existing vCenter instance, ESX hosts, and VMware Aria Operations, you must ensure that you comply with the prerequisites, follow the procedure, and perform the next steps.
...
| --- | --- | --- |
| Minimum component versions prior to running the VCF Installer workflow | - VMware Aria Operations 8.18 - VMware vCenter 9.0 - VMware ESX 9.0 | - VMware Aria Operations 8.18 - VMware vCenter 8.0 Update 1a - VMware ESX 8.0 Update 1a - VMware NSX 4.1.0.2 |
...
You can have multiple VMware Aria Operations instances in your VCF environment. By following this procedure, you choose a main instance to create the VCF fleet and connect the instance to the VCF Operations fleet management appliance. This instance will have full VCF Operations functionality. For all subsequent VMware Aria Operations instances, you must perform the upgrade manually. These will not be registered with the VCF Operations fleet management appliance and will have limited functionality.

1. Upgrade your VMware Aria Operations to VCF Operations version 9.0.x.

   See [Upgrading VMware Aria Operations to VCF Operations 9 without VMware Aria Suite Lifecycle](/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/deployment/upgrading-cloud-foundation/preparing-your-vcf-9-management-components/upgrade-backup-and-restore.html).
2. Ensure your vCenter instance is running the supported version for your convergence scenario.
...
3. Ensure your ESX hosts are running the supported version for your convergence scenario.
...
4. Deploy the VCF Installer appliance.
...
5. Download binaries to the VCF Installer appliance.
...
6. Deploy VCF 9.0.x by using your existing components as starting building blocks.
...
7. Deploy the remaining components.
...
8. Manually upgrade your subsequent Aria Operations instances to VCF Operations.

   See [Upgrading VMware Aria Operations 8.18 to 9.0 without VMware Aria Suite Lifecycle](/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-0/deployment/upgrading-cloud-foundation/preparing-your-vcf-9-management-components/upgrade-backup-and-restore.html).
